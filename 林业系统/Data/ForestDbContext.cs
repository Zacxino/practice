...
namespace Forest.Data
{
    public class ForestDbContext : DbContext
    {
        ...
        //public DbSet<LoggingAccount> LoggingAccounts { get; set; }
        //public DbSet<LoggingGPSInfo> LoggingGPSInfoes { get; set; }
        //public DbSet<LoggingMethod> LoggingMethods { get; set; }
    ...
    public class DefaultDbContextInitializer : DropCreateDatabaseIfModelChanges<ForestDbContext>
    {
        protected override void Seed(ForestDbContext context)
        {
            #region 初始化采伐方式
